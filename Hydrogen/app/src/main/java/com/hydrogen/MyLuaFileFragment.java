...
public class MyLuaFileFragment extends Fragment implements LuaGcable {
    ...
    public MyLuaFileFragment(String luaFilePath) {
        this(luaFilePath, new Object[0]);
    }

    public MyLuaFileFragment(String luaFilePath, Object[] args) {
        mLuaFilePath = luaFilePath;
        mArgs = (args != null) ? args : new Object[0];
    }

    public LuaTable getLayoutTable() {
        return mlayoutTable;
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (mLuaFilePath.charAt(0) != '/')
            mLuaFilePath = mLuaActivity.getLuaDir() + "/" + mLuaFilePath;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (result instanceof View) {
            ...
            ((TextView) mView).setText("Default View");
        ...
        try {
            if (mlayout != null)
                return  (View) ((LuaObject) (L.getLuaObject("require").call("loadlayout"))).call(mlayout);;
            return new TextView(getActivity());
        } catch (Exception e) {
            mLuaActivity.sendError(this.toString(), e);
            return new TextView(getActivity());
    ...
    private void initLua() {
        ...
        luaLpath =
                (luaDir + "/?.lua;" + luaDir + "/lua/?.lua;" + luaDir + "/?/init.lua;") + luaLpath;
